...
# Orchestrate order
# =======================
log "[3/4] Run order: IMU -> LiDAR -> CAN -> CAMERA_LOW ->CAMERA_HIGH -> EKF-> BRINGUP"
...
tmux wait-for -S STAGE_CAMERA_HIGH
timeout 40s tmux wait-for CAMERA_HIGH_OK || die "CAMERA_HIGH stage timed out"
