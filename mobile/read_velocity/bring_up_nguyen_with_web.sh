...
tmux new-window -t mobile -n web_mapping_backend "bash -lc 'source /opt/ros/humble/setup.bash; source ~/ros2_ws/install/setup.bash; python3 /home/pan/ros2_ws/src/mobile/read_velocity/web_mapping_backend.py; exec bash'"
